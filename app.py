...
''')
        ...
        if '3' in choice:
            ...
            os.system(f'docker run -d -it --restart always -u root -p 8080:8080 -p 50000:50000 -v /var/run/docker.sock:/var/run/docker.sock -v $(which docker):/usr/bin/docker -v jenkins_data:/var/jenkins_home --name {nameJenkins} jenkins/jenkins:latest')
